        ...
        <View style={{marginBottom: RFPercentage(2)}}>
          ...
          <View style={{margin: RFPercentage(2)}}>
            ...
            <View
              ...
              <FontAwesome
                onPress={() => {
                  Linking.openURL(settings.MediaLinks.Whatsapp).catch(error => {
                    ToastAndroid.show(
                      'Some error occurred, Please try again!',
                      ToastAndroid.SHORT,
                    );
              ...
              <FontAwesome
                onPress={() => {
                  Linking.openURL(settings.MediaLinks.Facebook).catch(error => {
                    ToastAndroid.show(
                      'Some error occurred, Please try again!',
                      ToastAndroid.SHORT,
                    );
              ...
              <FontAwesome5
                onPress={() => {
                  Linking.openURL(settings.MediaLinks.Youtube).catch(error => {
                    ToastAndroid.show(
                      'Some error occurred, Please try again!',
                      ToastAndroid.SHORT,
                    );
              ...
              <AntDesign
                onPress={() => {
                  Linking.openURL(settings.MediaLinks.Twitter).catch(error => {
                    ToastAndroid.show(
                      'Some error occurred, Please try again!',
                      ToastAndroid.SHORT,
                    );
              ...
              <Foundation
                onPress={() => {
                  Linking.openURL(settings.MediaLinks.Linkedin).catch(error => {
                    ToastAndroid.show(
                      'Some error occurred, Please try again!',
                      ToastAndroid.SHORT,
                    );
